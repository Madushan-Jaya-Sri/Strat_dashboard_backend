...
#             # If keyword period provided, convert it
#             elif extracted.get("period_keyword"):
...
#     Args:
#         keyword: Natural language period like "last 7 days", "yesterday"
#         module_type: Module type for specific formatting
        
#     Returns:
#         Tuple of (start_date, end_date, period_string)
#     """
...
#     # Last week
#     if "last week" in keyword or "past week" in keyword:
#         start = today - timedelta(days=7)
#         return (
#             start.strftime("%Y-%m-%d"),
#             today.strftime("%Y-%m-%d"),
#             "LAST_7_DAYS" if module_type in ["google_ads", "intent_insights"] else "day"
#         )
    
#     # Last month
#     if "last month" in keyword or "past month" in keyword:
#         start = today - timedelta(days=30)
#         return (
#             start.strftime("%Y-%m-%d"),
#             today.strftime("%Y-%m-%d"),
#             "LAST_30_DAYS" if module_type in ["google_ads", "intent_insights"] else "month"
#         )
    
#     # Last 30 days
#     if "30" in keyword and "day" in keyword:
#         start = today - timedelta(days=30)
#         return (
#             start.strftime("%Y-%m-%d"),
#             today.strftime("%Y-%m-%d"),
#             "LAST_30_DAYS" if module_type in ["google_ads", "intent_insights"] else "day"
#         )
